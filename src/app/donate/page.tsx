      ...
      <section className="space-y-10 max-w-5xl mx-auto">
        <div className="text-center space-y-2">
          ...
          <p className="font-sans text-base text-on-surface-variant max-w-xl mx-auto">
            Every contribution directly funds the upkeep of the Kali Bari and
            supports our community development initiatives.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {donationImpacts.map((impact) => (
            ...
            >
              <span
                className={`material-symbols-outlined text-[40px] ${impact.iconColor} shrink-0`}
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="space-y-3">
            ...
            <p className="font-sans text-base text-on-surface-variant leading-relaxed">
              We support direct digital transfers. Make a contribution via your
              mobile UPI app or standard Net Banking.
            </p>
          </div>
            ...
            <div className="flex flex-col items-center justify-center p-6 bg-surface-container-low border border-dashed border-outline-variant/60 rounded text-center space-y-4">
              ...
              <div className="bg-white p-3 rounded-lg border border-outline-variant/30 shadow-sm relative group overflow-hidden">
                <img
                  ...
                  className="w-45 h-45 transition-transform duration-300 group-hover:scale-102"
                />
              </div>
            ...
            <ul className="space-y-3 font-sans text-sm">
              <li className="flex justify-between items-baseline border-b border-outline-variant/10 pb-2">
                ...
                <span className="text-on-surface font-semibold text-right">
                  {siteContent.bankDetails.accountName}
                </span>
              </li>
              <li className="flex justify-between items-baseline border-b border-outline-variant/10 pb-2">
                <span className="text-on-surface-variant font-medium">
                ...
                <span className="text-on-surface font-semibold text-right">
                  {siteContent.bankDetails.bankName}
                </span>
              </li>
              <li className="flex justify-between items-baseline border-b border-outline-variant/10 pb-2">
                <span className="text-on-surface-variant font-medium">
                ...
                <span className="text-on-surface font-mono font-semibold text-right select-all">
                  {siteContent.bankDetails.accountNumber}
                </span>
              </li>
              <li className="flex justify-between items-baseline border-b border-outline-variant/10 pb-2">
                <span className="text-on-surface-variant font-medium">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="space-y-3">
            ...
            <p className="font-sans text-base text-on-surface-variant leading-relaxed">
              Once you have completed your payment transaction, please fill in
              the details below to request a formal receipt from the Kali Bari
