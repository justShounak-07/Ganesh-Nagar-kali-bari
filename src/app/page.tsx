...
export default function HomePage() {
  return (
    <div className="space-y-0">
      ...
      <section className="relative -mt-16 z-20 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        <div className="bg-surface-card border border-tertiary-container/30 p-8 flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16 shadow-[0_4px_24px_rgba(43,22,19,0.05)] rounded-lg">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-sans text-xs font-semibold text-on-surface-variant uppercase tracking-wider">
                Morning Darshan
              </p>
              <p className="font-display text-xl md:text-2xl font-bold text-primary">
                {siteContent.templeTimings.darshan.morning}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="font-display text-xl md:text-2xl font-bold text-primary">
                {siteContent.templeTimings.darshan.evening}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-3">
              <span className="font-sans text-sm font-semibold text-secondary uppercase tracking-widest">
                Our Heritage
              </span>
              <h2 className="font-display text-3xl md:text-5xl font-bold text-primary leading-tight">
                A Sanctuary of Devotion and Community
              </h2>
            </div>
            <p className="font-sans text-base md:text-lg text-on-surface-variant leading-relaxed">
              For decades, the {siteContent.brand.name} has stood as a spiritual
              solace and cultural vibrancy. Rooted in the rich Bengali
              traditions, our temple is more than a place of worship. It is
              beating heart of our community, where devotion meets service.
            </p>
            <div className="pt-2">
              <Link
                href="/about/history"
      ...
      <section
        className="py-24 px-margin-mobile md:px-margin-desktop bg-primary text-on-primary relative overflow-hidden"
        id="support"
      >
        ...
        <div className="max-w-[1000px] mx-auto text-center relative z-10 space-y-8">
          <span
            className="material-symbols-outlined text-[56px] text-tertiary-container mb-2"
            style={{ fontVariationSettings: '"FILL" 1' }}
          >
            volunteer_activism
          </span>
          ...
          <p className="font-sans text-base md:text-lg text-on-primary/80 leading-relaxed max-w-2xl mx-auto">
            Your generous contributions enable us to sustain daily pujas,
            maintain our beautiful heritage structures, and expand our social
            welfare programs like healthcare camps and food drives.
          </p>
          <div className="pt-3 flex justify-center">
            <Button
              variant="large"
              href="/donate"
              className="bg-secondary hover:bg-secondary-container  transform hover:scale-150 text-white border-none shadow-xl rounded-2xl"
            >
              Proceed to Donation
            </Button>
          </div>
